            ...
            <footer class="sticky-footer bg-light">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Sistem Pembukuan Produk dan Report Penjualan &bull; by <?= anchor('Ody.Sub'); ?></span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
            ...
            var myLineChart = new Chart(ctx, {
                ...
                data: {
                    ...
                    datasets: [{
                            ...
                            borderColor: "#ff3bae",
                            pointRadius: 3,
                            pointBackgroundColor: "#ff3bae",
                            pointBorderColor: "#ff3bae",
                            pointHoverRadius: 3,
                        ...
                        },
                        {
                            ...
                            borderColor: "#d431f5",
                            pointRadius: 3,
                            pointBackgroundColor: "#d431f5",
                            pointBorderColor: "#d431f5",
                            pointHoverRadius: 3,
                            pointHoverBackgroundColor: "#5a5c69",
                            pointHoverBorderColor: "#5a5c69",
                            pointHitRadius: 10,
